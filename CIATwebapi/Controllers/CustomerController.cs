...
public class CustomerController : ControllerBase
{
    ...
    public Response InsertCustomer([FromBody] Customer customer)
    {
        ...
        try
        {
            ...
            string? insertCustomerUsername = customer.userName;
            string? insertCustomerPassword = customer.password;
            ...
            {
                sqlConnection.Open();
                rowsAffected = Customer.InsertCustomer(sqlConnection, insertCustomerUsername, insertCustomerPassword);
                // ticket = Ticket.SearchTicket(sqlConnection);
            }
